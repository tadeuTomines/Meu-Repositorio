...
function nomePedido(nomeLanche){
 for (let index = 0; index < menu.sandwiches.length; index +=1){
    if (nomeLanche === menu.sandwiches[index].name){
        resultado = menu.sandwiches[index];
    }
 } return resultado;
} 

nomePedido('Duplo Quarterão');

console.log(resultado);

//console.log(menu.sandwiches[2]);